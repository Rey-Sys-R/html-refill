...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const button1Html = '<button class="btn btn-primary" style="width:100px; margin-bottom:10px;" onclick="sendPayload(\'button6\')">Refill</button>';
